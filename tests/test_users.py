...
sys.path.append('../registration') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response = self.register('ttttttttttttttttttttttttttttttttttt', 'test@example.com', 'FlaskIsAwesome')
        self.assertIn(b'Field must be between 2 and 20 characters long.', response.data)
